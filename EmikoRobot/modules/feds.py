...
from EmikoRobot.modules.sql.feds_sql import *
...
__button__ = [ InlineKeyboardButton(text="FED ADMIN COMMANDS", callback_data="indiafedadmin_"),
            InlineKeyboardButton(text="FED OWNER COMMANDS", callback_data="indiafedowner_"),            
] 
