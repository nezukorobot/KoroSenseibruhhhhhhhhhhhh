...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if message.reply_to_message and message.reply_to_message.sender_chat:
        ...
        if r:
            message.reply_text("Channel {} jyada shanpati karra tha leleouch se  {}".format(
    ...
    if not user_id:
        message.reply_text("⚠️ bevkoof sahi id de .")
        return log_message
    try:
        ...
        if excp.message != "User not found":
            raise
        message.reply_text("sahi username de vai/vehen .")
        return log_message
    if user_id == bot.id:
        message.reply_text(" jyada shanpati nahi lelouch se ")
        return log_message

    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text(" how dare you to ban Lord Divine")
        elif user_id in DEV_USERS:
            message.reply_text("I can't act against our son.")
        elif user_id in DRAGONS:
            message.reply_text(
                " sudo ha uspei ma nahi ban kar sakta LMAOOOO."
            )
            ...
            message.reply_text("⚠️ abe andhee vo adhmin ha!!!!!!.")
        return log_message
